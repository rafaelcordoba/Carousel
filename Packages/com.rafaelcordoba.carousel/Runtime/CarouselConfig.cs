...
namespace Carousel.Runtime
{
    ...
    {
        [Tooltip("How many items in the carousel.")] [Range(1, 20)]
        public int visibleItemsPerSide = 2;

        [Header("Layout Settings")] [Tooltip("Horizontal spacing between items.")]
        ...
        [Header("Animation Settings")] [Tooltip("Duration of the transition animation in seconds.")]
